...
async function handleComeCommand(interaction: any) {
...
async function handleInitiateCommand(interaction: any) {
...
async function handleDestroySubcommand(interaction: any) {
...
async function handleFridaySubcommand(interaction: any) {
  await interaction.deferReply({
    ephemeral: true
  });
...
async function handleTensorflowSubcommand(interaction: any) {
  await interaction.deferReply({
    ephemeral: true
  });
  try {
...
async function handleNanobotsSubcommand(interaction: any) {
  await interaction.deferReply({
    ephemeral: true
  });
  try {
...
export {
  ...
  handleTensorflowSubcommand,
  handleNanobotsSubcommand
};
